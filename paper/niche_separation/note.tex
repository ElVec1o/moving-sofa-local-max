...
$2\tan\beta$ is the real root of $u^{3}+3u=2$, and
\[
...
\begin{remark}
Every step was also checked numerically at $60$ digits. Romik tabulates $a_1$ and
$\beta$ separately; we have not found Theorem~\ref{thm:a1beta} or
Corollary~\ref{cor:ucubic} stated in the literature. The two polynomial steps
\eqref{eq:xcubic} and the Cardano substitution are machine-checked
(\verb|u_sq_cubic|, \verb|cardano_substitution|).
\end{remark}
...
\begin{remark}[Where the difficulty of the ambidextrous problem sits]
