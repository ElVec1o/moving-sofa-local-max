...
%
%  (the tail bound is a magnitude bound; see sec:passage-fails).
% =====================================================================
...
\begin{proof}
The decomposition argument of Section~\ref{sec:passage-fails} in
...
is the corresponding tail figure.  Both are comfortably bounded
away from zero.  The strict-local-maximality theorem
(Theorem~\ref{thm:truncated}) is unaffected by the present
