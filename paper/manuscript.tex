...
$1.25\times10^{-3}$.  At $b_{1}$ it is $G(\varepsilon) = -0.100\,
\varepsilon^{2}$ to six digits; at $b_{2}$, $-0.107\,\varepsilon^{2}$;
both are strictly negative on the whole sampled ball
$\varepsilon\in(0,0.6]$, in both components.
