...
(F1)--(F3) are finite computations, and the measured evidence
(the $N=16$ block with $m_{1}=0.596$ in the $H^{1}$ metric; sampled
couplings an order of magnitude below the diagonal) indicates they
hold with margin.  We emphasize what has changed relative to every
earlier attempt in this manuscript's history: the conditional
hypotheses are no longer analytic estimates that might be false ---
they are evaluations of one explicit quadratic form.
