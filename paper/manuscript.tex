...
premise; completing (F3) is now literally the mechanical repetition
of this call over the remaining entries ($\approx$ one hour of
compute), not a method question.
