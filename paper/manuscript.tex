...
$H^{2}$-sphere;
(iii) $K\to\infty$ control of the true-Hessian blocks (the
$m_{1}$-trend $0.72,0.70,0.596$; a checkpointed runner for the
$K=24,32$ blocks is provided as
\texttt{rigorous/true\_hessian\_runner.py});
