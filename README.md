...
Lean 4.33. **880 theorems, no `sorry`.** The 114-theorem core (`MovingSofa/Basic.lean`)
...
so the identities stay decidable. The remaining 766 theorems use Mathlib. Instantiating
