...
Lean 4.33. **886 theorems, no `sorry`.** The 114-theorem core (`MovingSofa/Basic.lean`)
...
so the identities stay decidable. The remaining 772 theorems use Mathlib. Instantiating
