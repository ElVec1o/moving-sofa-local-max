...
Lean 4.33. **866 theorems, no `sorry`.** The 114-theorem core (`MovingSofa/Basic.lean`)
...
so the identities stay decidable. The remaining 752 theorems use Mathlib. Instantiating
