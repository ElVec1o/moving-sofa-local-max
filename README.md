...
| 74 | **UPPER BOUND: $A_{\text{ambi}}\le1.90$.** Branch and bound over the three-parameter reduction, $324707$ boxes, all discharged in $105$s; the box bound is verified sound against the true objective on $36000$ sampled points. With Romik's sofa this brackets the answer: $1.6449552\le A_{\text{ambi}}\le1.90$, a factor of $1.155$. **The first bound specific to the ambidextrous problem**; the previous one, $2.2195$, was inherited from the one-corner theorem | PROVED (computer-assisted) |
