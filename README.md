...
Lean 4.33. **894 theorems, no `sorry`.** The 114-theorem core (`MovingSofa/Basic.lean`)
...
so the identities stay decidable. The remaining 780 theorems use Mathlib. Instantiating
